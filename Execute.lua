...
local function drag(frame, parent)
  ...
  frame.InputBegan:Connect(function(input)
    if input.UserInputType == game:GetService("UserInputService").MouseEnabled and Enum.UserInputType.MouseButton1 or Enum.UserInputType.Touch then
      dragging = true
  ...
  frame.InputChanged:Connect(function(input)
    if input.UserInputType == game:GetService("UserInputService").MouseEnabled and Enum.UserInputType.MouseMovement or Enum.UserInputType.Touch then
      dragInput = input
    end
  end)
